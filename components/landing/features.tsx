...
import { AccessibilityIcon, CopyIcon, Code2Icon, MoonIcon, SparkleIcon, CheckCircle2Icon } from "lucide-react"
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from "@/components/ui/card"

export function Features() {
  return (
    <section id="features" className=" border-t border-b border-border border-dashed">
