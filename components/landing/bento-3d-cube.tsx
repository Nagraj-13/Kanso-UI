      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 border border-zinc-300 dark:border-zinc-700/50 rounded-full" />

            {/* Primary Axes (renders as center diagonals) */}
            <div className="absolute top-1/2 left-0 w-full h-[1px] -translate-y-1/2 border-t border-dashed border-zinc-300 dark:border-zinc-700" />
            <div className="absolute top-0 left-1/2 w-[1px] h-full -translate-x-1/2 border-l border-dashed border-zinc-300 dark:border-zinc-700" />

            {/* Secondary Parallel Lines */}
            <div className="absolute top-[calc(50%-160px)] left-0 w-full h-[1px] -translate-y-1/2 border-t border-dashed border-zinc-200 dark:border-zinc-800" />
            <div className="absolute top-[calc(50%+160px)] left-0 w-full h-[1px] -translate-y-1/2 border-t border-dashed border-zinc-200 dark:border-zinc-800" />

            <div className="absolute top-0 left-[calc(50%-160px)] w-[1px] h-full -translate-x-1/2 border-l border-dashed border-zinc-200 dark:border-zinc-800" />
            <div className="absolute top-0 left-[calc(50%+160px)] w-[1px] h-full -translate-x-1/2 border-l border-dashed border-zinc-200 dark:border-zinc-800" />
            ...
            <div className="absolute top-[calc(50%+160px)] left-[30%] -translate-y-[14px] text-[10px] tracking-widest font-mono text-zinc-400/60 dark:text-zinc-700 font-medium">
              SEC_002
            </div>
          </div>
          ...
          >
            ...
            <div className="bento-face top top-0 left-0">
              <div className="size-[60px] rounded-full border-2  border-zinc-300 dark:border-white/10 flex items-center justify-center animate-[spin-bento_8s_linear_infinite] group-hover:border-zinc-500/40 group-hover:animate-[spin-bento_4s_linear_infinite] relative">
