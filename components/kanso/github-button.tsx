...
export interface GithubButtonProps extends React.ComponentPropsWithoutRef<
  typeof Button
> {
  ...
  (
    ...
    const getGlowBg = (color?: string) => {
      ...
      const presets: Record<string, string> = {
        violet:
          'linear-gradient(135deg, oklch(0.6 0.25 300), oklch(0.5 0.3 320))',
        rose: 'linear-gradient(135deg, oklch(0.65 0.25 0), oklch(0.55 0.3 20))',
        emerald:
          'linear-gradient(135deg, oklch(0.7 0.25 140), oklch(0.6 0.3 160))',
        blue: 'linear-gradient(135deg, oklch(0.6 0.25 250), oklch(0.5 0.3 270))',
        orange:
          'linear-gradient(135deg, oklch(0.7 0.25 45), oklch(0.6 0.3 65))',
        rainbow:
